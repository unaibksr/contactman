      ...
      <div className="pt-4 px-6 pb-2">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2.5">
            <h1 className="text-2xl font-semibold tracking-tight text-[#E0E0E0]">
              {selectionMode ? `${selectedCount} Selected` : 'Contacts'}
            </h1>
          </div>
            ...
            {selectionMode ? (
              <>
                <button
                  ...
                  className="px-3 py-1.5 rounded-xl text-xs font-medium bg-[#252525] text-[#888888] hover:text-[#E0E0E0] transition"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="p-2 bg-rose-500/10 text-rose-400 rounded-full hover:bg-rose-500/20 active:scale-95 transition disabled:opacity-40"
